...
Public Class CNFPartywise
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim portname As String = obj.GetOneValueFromQuery("select packing_portname from granite_packinglistheader where packing_vesselname  ='" + vesselname + "'")
        ...
        Me.cnfpartyreport.Text = cnfparty
        ...
        dd = obj.getdatatable("select distinct b.packing_cnfagent,b.packing_shippername,b.packing_marks,sum(convert(float, a.blocknumber))as blocknumber," & _
        ...
        gvDetails.FooterRow.Cells(3).HorizontalAlign = HorizontalAlign.Right
